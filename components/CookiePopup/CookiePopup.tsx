          ...
          <div className="modal">
              <div className="modal-box">
                  ...
                  <p className="pt-4 text-center">
                      We use cookies to enhance your browsing experience and to improve our service. By
                      clicking &apos;Accept All&apos;, you consent to our use of cookies.
                  </p>
                  <div className="modal-action justify-center gap-10">
                      <button className="btn btn-secondary" onClick={async () => { await updateCookieConsent(false) }}>
                          Reject All
                      </button>
                      <button className="btn btn-primary" onClick={async () => { await updateCookieConsent(true) }}>
                          Accept All
                      </button>
                  </div>
              </div>
